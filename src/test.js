...
if (origin === "c"){
  if (destination = "f"){
temp = (temp * (9 / 5)) + 32
console.log(temp2 + "\u00b0C equals" + temp + "\u00b0F")
  } else if (destination = "k"){
temp = temp + 273.15
console.log(temp2 + "\u00b0C equals" + temp + "\u00b0K")
  }
} else if (origin === "f"){
  if (destination = "c"){
temp = (temp - 32) * (5 / 9)
console.log(temp2 + "\u00b0F equals" + temp + "\u00b0C")
  } else if (destination = "k"){
temp = (temp - 32) * (5 / 9) + 273.15
console.log(temp2 + "\u00b0F equals" + temp + "\u00b0K")
} else if (origin === "k"){
    if (destination = "c"){
  temp = temp - 273.15
  console.log(temp2 + "\u00b0K equals" + temp + "\u00b0C")
} else if (destination = "f"){
  temp = (temp - 273.15) * (5 / 9) + 32
  console.log(temp2 + "\u00b0K equals" + temp + "\u00b0Fss")
    }
  }
}
